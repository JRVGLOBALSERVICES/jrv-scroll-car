    ...
    <main>
      ...
      <div style={{
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 md:p-8 z-10">
          <a href="https://wa.me/60126565477" className="bg-[#FF4500] text-white font-bold px-7 py-3 rounded-xl text-sm inline-block">Book via WhatsApp</a>
        </div>
      </div>
      ...
      <div style={{ opacity: isEnded ? 1 : 0 }}>
        ...
        <section className="py-16 md:py-20 bg-[#FFF8F0] border-t border-gray-100">
          <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 md:gap-4">
              {[{ t: "Zero Deposit", d: "No deposit needed." },{ t: "Free Delivery", d: "Within Seremban." },{ t: "Unlimited KM", d: "No limits." },{ t: "24/7 Service", d: "Round-the-clock." },{ t: "Latest Models", d: "2024-2026." },{ t: "KLIA Service", d: "Airport pickup." },{ t: "Best Rates", d: "From RM 110." },{ t: "Replacement", d: "If breakdown." }].map(f => (
                <div key={f.t} className="bg-white border border-gray-200 rounded-xl p-4"><h3 className="font-bold text-black text-sm">{f.t}</h3><p className="text-gray-500 text-[11px] mt-1">{f.d}</p></div>
              ))}
            </div>
          </div>
        </section>
        ...
        <section id="faq" className="py-16 md:py-20 bg-white">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-2">
              {[{ q: "Documents?", a: "License, IC/passport." },{ q: "Deposit?", a: "Zero. Rare." },{ q: "Mileage limit?", a: "Unlimited." },{ q: "Breakdown?", a: "24/7 + replacement." }].map((f, i) => (
                <details key={i} className="group border border-gray-200 rounded-xl overflow-hidden">
                  <summary className="px-4 py-3.5 cursor-pointer text-black font-semibold text-sm flex justify-between">{f.q}<span className="text-[#FF4500] group-open:rotate-180 text-xs">▾</span></summary>
        ...
        <section className="bg-[#FF4500] py-14">
          <div className="max-w-3xl mx-auto px-4 text-center">
            ...
            <div className="flex justify-center mt-7">
              <a href="https://wa.me/60126565477" className="bg-black text-white font-bold px-8 py-3.5 rounded-xl text-sm">Book via WhatsApp</a>
            </div>
          </div>
        </section>
        ...
        <footer className="bg-[#111118] text-white/40 py-8 text-center text-[11px]">
          ...
          <p>Powered by <a href="https://jrvsystems.app" className="text-[#FF4500]">JRV Systems</a></p>
        </footer>
      </div>
    </main>
  );
